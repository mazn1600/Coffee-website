...
<head>
    ...
    <title>تسجيل حساب مشرف | قهوتنا</title>
...
<body>
    ...
    <section class="hero">
        <div class="hero-content">
            <h1>تسجيل حساب مشرف</h1>
            <p>أنشئ حساب مشرف لإدارة الموقع</p>
            ...
            <form class="auth-form" method="post" action="admin_register.php">
                ...
                <input type="password" name="secret_code" placeholder="رمز التحقق" required />
